...
static int (*bpf_test_call_func)(void) = (void *) BPF_FUNC_test_call_func;
// static int (*bpf_copy_to_buf)(void *buf, __u32 size) = (void *) BPF_FUNC_copy_to_buf;
static int (*bpf_write_current_buf)(int obs_type, void *buf, __u64 size) = (void *) BPF_FUNC_write_current_buf;
static int (*bpf_write_omni_buf_k)(void *buf, __u64 size) = (void *) BPF_FUNC_write_omni_buf_k;
