...
// INTR_PROP_DESC(49152, GIC_HIGHEST_SEC_PRIORITY, (grp),
// 		GIC_INTR_CFG_EDGE)
...
#if ENABLE_HHKRD		/* hhkrd extra world map support */
/* Map NS kernel accessable by the atf */
...
#define TTBR_TRANS_PATH_2 	MAP_REGION_FLAT(			\
						...
						UL(0x3E008000),\
						MT_MEMORY | MT_RW | MT_NS)
/* we borrow this region to EL3 to act as GPT */
...
/* NS memory 2GB to (end - 16MB) (0x8000_0000 - 0xff00_0000) */
#define ARM_PAS_2_BASE			(ARM_PAS_1_BASE + ARM_PAS_1_SIZE)   /* 2GB 0x8000_0000 */
#define ARM_PAS_2_SIZE			(ARM_NS_DRAM1_SIZE)					/* 2GB - 16MB */


#if ENABLE_HHKRD	/* hhkrd GPT memory layout */
	#define HHKRD_MAX				0x10
	/* L0 GPT for hhkrd */
	#define ARM_PAS_L0_GPT_BASE		0xC0010000	/* Modify to 0xa001000 in juno env */
	#define ARM_PAS_L0_GPT_SIZE		ARM_L0_GPT_SIZE * HHKRD_MAX
	/* L1 GPT for hhkrd */
	#define ARM_PAS_L1_GPT_BASE		ARM_PAS_L0_GPT_BASE	+ ARM_PAS_L0_GPT_SIZE
	#define ARM_PAS_L1_GPT_SIZE		ARM_L1_GPT_SIZE * HHKRD_MAX
#endif
...
#define	ARM_PAS_KERNEL			MAP_GPT_REGION_TBL(ARM_PAS_2_BASE, \
							   ...
							   GPI_NS)
#else
/* We borrow (0xC001_0000) from the normal os region to act as the GPT.
 * So here we break down the kernel - (kernel, l0_gpt, l1_gpt, kernel2, kernel3)
 */
#define	ARM_PAS_KERNEL			MAP_GPT_REGION_TBL(ARM_PAS_2_BASE, \
